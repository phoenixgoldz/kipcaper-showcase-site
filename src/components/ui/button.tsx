  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-electric-blue to-cyber-purple text-white shadow-xl hover:shadow-2xl transform hover:scale-105 hover:from-cyber-purple hover:to-electric-blue border border-white/20",
        gaming: "bg-gradient-to-r from-neon-green to-electric-blue text-white shadow-xl hover:shadow-2xl transform hover:scale-105 relative",
        premium: "bg-gradient-to-r from-gold-accent to-electric-blue text-white shadow-xl hover:shadow-2xl transform hover:scale-105 border border-gold-accent/30",
      },
      size: {
